...
//                    );
        ...
        $subtabs['deleted'] = array( 
                            ...
                            , 'title' =>  $icon . __('Deleted' ,'booking') . $sufix        // Title of TAB    
                            , 'page_title' => __('Emails Settings', 'booking')  // Title of Page   
...
//debuge ( wpbc_import6_email__deleted__get_fields_array_for_activation() );
...
//          ) return;
        ...
        $js_script .= "     var wpbc_email_from = jQuery('#deleted_from').val();";    // from@wpbookingcalendar.com 
